...
from transformmodeltoimagespacestep.ui_configuredialog import Ui_ConfigureDialog
...
class ConfigureDialog(QtGui.QDialog):
    ...
    def getConfig(self):
        ...
        config['Mirror'] = self._ui.lineEdit1.text()
        config['Z Shift'] = self._ui.lineEdit2.text()
        return config
